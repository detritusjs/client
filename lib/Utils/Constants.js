...
module.exports = {
	...
	ErrorCodes: {
		JSON: {
			...
			20010: 'A verified connection is required to set visibility',
			...
			50003: 'Cannot excecute action on a DM channel',
			...
			50016: 'Provided too few or too many messages to delete. Must provide as least 2 and fewer than 100 messages to delete',
		...
		Websocket: {
			...
			Voice: {
				...
				4003: 'Not Authenticated',
				4004: 'Authentication Failed',
				4005: 'Session is no longer valid',
