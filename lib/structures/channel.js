...
const ChannelTypes = Utils.Constants.Discord.ChannelTypes;
...
class Channel extends BaseStructure{
	...
	get jumpLink() {
		return Endpoints.REST.URL + Endpoints.ROUTES.CHANNEL(this.guildId, this.id);
	}
	
	get isDm() {return this.isDmSingle || this.isDmGroup;}
	get isDmSingle() {return this.type === ChannelTypes.DM;}
	get isDmGroup() {return this.type === ChannelTypes.GROUP_DM;}

	get isGuildChannel() {return this.isCategory || this.isText || this.isVoice;}
	get isCategory() {return this.type === ChannelTypes.GUILD_CATEGORY;}
	get isText() {return this.type === ChannelTypes.GUILD_TEXT;}
	get isVoice() {return this.type === ChannelTypes.GUILD_VOICE;}
...
Channel.create = function(client, data) {
	let Class = Channel;
	switch (data.type) {
		case ChannelTypes.GUILD_TEXT:     Class = Structures.ChannelGuildText; break;
		case ChannelTypes.DM:             Class = Structures.ChannelDM; break;
		case ChannelTypes.GUILD_VOICE:    Class = Structures.ChannelGuildVoice; break;
		case ChannelTypes.GROUP_DM:       Class = Structures.ChannelDMGroup; break;
		case ChannelTypes.GUILD_CATEGORY: Class = Structures.ChannelGuildCategory; break;
	}
