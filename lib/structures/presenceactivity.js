...
class PresenceActivity extends BaseStructure {
	...
	fetchMetadata() {
		return (this.sessionId) ? this.client.rest.fetchActivityMetadata(this.presence.user.id, this.sessionId) : Promise.reject(new Error('This activity doesn\'t support metadata'));
	}
