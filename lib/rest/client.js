...
class RestClient extends DetritusRest.Client {
	...
	editEmoji(guildId, emojiId, body) {
		return super.editEmoji.call(this, guildId, emojiId, body);
	}
	...
	editMember(guildId, userId, body) {
		return super.editMember.call(this, guildId, userId, body);
	}
	...
	editRole(guildId, roleId, body) {
		return super.editRole.call(this, guildId, roleId, body);
	}
	
	//returns list of role objects
	editRolePositions(guildId, body) {
		return super.editRolePositions.call(this, guildId, body);
	}
