...
class ChannelText extends Structures.Channel
{
	...
	bulkDelete(messageIds) {return this.client.rest.endpoints.bulkDeleteMessages(this.id, messageIds);}

	createInvite(data) {return this.client.rest.endpoints.createInvite(this.id, data);}
	createMessage(data) {return this.client.rest.endpoints.createMessage(this.id, data);}
	createWebhook(data) {return this.client.rest.endpoints.createWebhook(this.id, data);}

	fetchInvites() {return this.client.rest.endpoints.fetchChannelInvites(this.id);}
	fetchMessage(id) {return this.client.rest.endpoints.fetchMessage(this.id, id);}
	fetchMessages(query) {return this.client.rest.endpoints.fetchMessages(this.id, query);}
	fetchPins() {return this.client.rest.endpoints.fetchPinnedMessages(this.id);}
	
	triggerTyping() {return this.client.rest.endpoints.triggerTyping(this.id);}
