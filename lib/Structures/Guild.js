...
class Guild extends BaseStructure
{
    ...
    get afkChannel()
    {
		return (this.afkChannelId) ? this.client.channels.get(this.afkChannelId) : null;
    }
    ...
    get systemChannel()
    {
        return (this.systemChannelId) ? this.client.channels.get(this.systemChannelId) : null;
    }
	...
	createChannel(data)
	{
		return this.client.rest.endpoints.createChannel(this.id, data);
	}
