...
class Guild extends BaseStructure
{
	...
	addMember(id, data) {return this.client.rest.endpoints.addMember(this.id, id, data);}
	addMemberRole(id, roleId) {return this.client.rest.endpoints.addMemberRole(this.id, id, roleId);}

	beginPrune() {return this.client.rest.endpoints.beginPrune(this.id);}

	createBan(id, query) {return this.client.rest.endpoints.createBan(this.id, id, query);}
	createChannel(data) {return this.client.rest.endpoints.createChannel(this.id, data);}
	createEmoji(data) {return this.client.rest.endpoints.createEmoji(this.id, data);}
	createIntegration(data) {return this.client.rest.endpoints.createGuildIntegration(this.id, data);}
	createRole(data) {return this.client.rest.endpoints.createRole(this.id, data);}

	delete() {return this.client.rest.endpoints.deleteGuild(this.id);}
	deleteEmoji(id) {return this.client.rest.endpoints.deleteEmoji(this.id, id);}
	deleteIntegration(id) {return this.client.rest.endpoints.deleteGuildIntegration(this.id, id);}
	deleteRole(id) {return this.client.rest.endpoints.deleteRole(this.id, id);}

	edit(data) {return this.client.rest.endpoints.editGuild(this.id, data);}
	editChannel(id, data) {return this.client.rest.endpoints.editChannel(this.id, data);}
	editChannelPositions(data) {return this.client.rest.endpoints.editChannelPositions(this.id, data);}
	editEmbed(data) {return this.client.rest.endpoints.editGuildEmbed(this.id, data);}
	editEmoji(id, data) {return this.client.rest.endpoints.editEmoji(this.id, id, data);}
	editIntegration(id, data) {return this.client.rest.endpoints.editGuildIntegration(this.id, id, data);}
	editMember(id, data) {return this.client.rest.endpoints.editMember(this.id, id, data);}
	editNick(data) {return this.client.rest.endpoints.editNick(this.id, data);}
	editRole(id, data) {return this.client.rest.endpoints.editRole(this.id, id, data);}
	editRolePositions(data) {return this.client.rest.endpoints.editRolePositions(this.id, data);}
	editVanityUrl(data) {return this.client.rest.endpoints.editVanityUrl(this.id, data);}

	fetchAuditLogs(query) {return this.client.rest.endpoints.fetchGuildAuditLogs(this.id, query);}
	fetchBans() {return this.client.rest.endpoints.fetchBans(this.id);}
	fetchChannels() {return this.client.rest.endpoints.fetchChannels(this.id);}
	fetchEmbed() {return this.client.rest.endpoints.fetchGuildEmbed(this.id);}
	fetchEmoji(id) {return this.client.rest.endpoints.fetchEmoji(this.id, id);}
	fetchEmojis() {return this.client.rest.endpoints.fetchEmojis(this.id);}
	fetchInvites() {return this.client.rest.endpoints.fetchGuildInvites(this.id);}
	fetchIntegrations() {return this.client.rest.endpoints.fetchGuildIntegrations(this.id);}
	fetchMember(id) {return this.client.rest.endpoints.fetchMember(this.id, id);}
	fetchMembers() {return this.client.rest.endpoints.fetchMembers();}
	fetchPruneCount() {return this.client.rest.endpoints.fetchPruneCount(this.id);}
	fetchRoles() {return this.client.rest.endpoints.fetchRoles(this.id);}
	fetchVanityUrl() {return this.client.rest.endpoints.fetchVanityUrl(this.id);}
	fetchVoiceRegion()
	{
	...
	fetchVoiceRegions() {return this.client.rest.endpoints.fetchVoiceRegions(this.id);}
	fetchWebhooks() {return this.client.rest.endpoints.fetchGuildWebhooks(this.id);}

	removeBan(id) {return this.client.rest.endpoints.removeBan(this.id, id);}
	removeMember(id) {return this.client.rest.endpoints.removeMember(this.id, id);}
	removeMemberRole(id, roleId) {return this.client.rest.endpoints.removeMemberRole(this.id, id, roleId);}

	search(query) {return this.client.rest.endpoints.searchGuild(this.id, query);}
	syncIntegration(id) {return this.client.rest.endpoints.syncGuildIntegration(this.id, id);}
