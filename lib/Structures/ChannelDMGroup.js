...
class ChannelDMGroup extends Structures.ChannelDM
{
	...
	addRecipient(userId, data) {return this.client.rest.endpoints.addRecipient(this.id, userId, data);}

	removeRecipient(userId) {return this.client.rest.endpoints.removeRecipient(this.id, userId);}
}
