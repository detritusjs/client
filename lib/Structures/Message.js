...
class Message extends BaseStructure
{
	...
	delete() {return this.client.rest.endpoints.deleteMessage(this.channelId, this.id);}
	deleteReactions() {return this.client.rest.endpoints.deleteReactions(this.channelId, this.id);}
	edit(data) {return this.client.rest.endpoints.editMessage(this.channelId, this.id);}
	pin() {return this.client.rest.endpoints.addPinnedMessage(this.channelId, this.id);}
	react(emoji) {return this.client.rest.endpoints.createReaction(this.channelId, this.id, emoji);}
	...
	reply(data)
	{
		...
		return this.client.rest.endpoints.createMessage(this.channelId, data);
	}

	unpin() {return this.client.rest.endpoints.deletePinnedMessage(this.channelId, this.id);}
